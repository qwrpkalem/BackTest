...
# (종목명, 진입일, 청산일, 보유기간(거래일), 수익률%) — 블로그 공개 상위 10개
# 보유기간은 저쪽이 '거래일' 로 세고 있다 (삼성전기 2026-04-08~07-02 = 달력 85일 / 거래일 61일).
BLOG = [
    ("대우건설",         "2026-02-10", "2026-05-12", 65, 343.83),
    ("원익홀딩스",       "2025-08-25", "2025-11-17", 60, 296.86),
    ("에코프로",         "2023-02-07", "2023-05-08", 64, 295.44),
    ("삼성전기",         "2026-04-08", "2026-07-02", 61, 279.24),
    ("셀바스AI",         "2023-01-09", "2023-03-03", 50, 264.04),
    ("에스티큐브",       "2022-07-07", "2022-08-30", 38, 192.35),
    ("금양",             "2022-07-22", "2022-09-29", 48, 191.67),
    ("실리콘투",         "2024-05-09", "2024-06-28", 36, 188.96),
    ("씨어스",           "2025-08-22", "2025-12-05", 75, 177.12),
    ("HLB바이오스텝",    "2022-05-11", "2022-06-17", 27, 150.65),
]
...
def measure(quick=False, verbose=True):
    ...
    for nm, ed, xd, bhold, ret in BLOG:
